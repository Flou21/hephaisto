...
public sealed class PolicyEngineTests
{
    ...
    {
        var facts = Given.Facts() with { TargetLabels = Given.Labels(("watchtower.io/protected", "true")) };
    ...
    public void ProtectedLabelWithDifferentValue_DoesNotDeny()
    {
        ...
        var facts = Given.Facts() with { TargetLabels = Given.Labels(("watchtower.io/protected", "false")) };
