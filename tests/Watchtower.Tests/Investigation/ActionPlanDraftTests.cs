...
/// <summary>
/// The boundary between "what a language model produced" and "what Watchtower will consider
...
public class ActionPlanDraftTests
{
    ...
    public void A_permanently_denied_type_deserialises_rather_than_throwing()
    {
        ...
        var draft = JsonSerializer.Deserialize<ActionDraft>(
            """{"type":"DeletePvc","namespace":"watchtower-chaos","kind":"PersistentVolumeClaim","name":"data"}""",
            Json);
    ...
    public void Mapping_leaves_the_decision_at_default_deny()
    {
        ...
        action.Target.WorkloadKey.Should().Be("watchtower-chaos/Deployment/api");
    }
