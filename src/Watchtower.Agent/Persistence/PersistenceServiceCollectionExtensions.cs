...
{
    public static async Task MigrateWatchtowerDatabaseAsync(this IHost host, CancellationToken ct = default)
    {
        await using var scope = host.Services.CreateAsyncScope();

        var logger = scope.ServiceProvider
            .GetRequiredService<ILoggerFactory>()
            .CreateLogger("Watchtower.Agent.Persistence.Migrations");
