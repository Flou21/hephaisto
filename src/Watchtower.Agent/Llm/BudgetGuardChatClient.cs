    ...
    Guid? incidentId = null) : DelegatingChatClient(inner)
{
    ...
    /// free investigation. Nothing in Watchtower streams: the UI renders persisted steps, not
    ...
    public override IAsyncEnumerable<ChatResponseUpdate> GetStreamingResponseAsync(
        ...
        throw new NotSupportedException(
            "Watchtower does not stream LLM responses: streaming usage accounting is not reliable "
