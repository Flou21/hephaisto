...
{
    public static IServiceCollection AddWatchtowerLlm(
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSingleton<IEmbeddingGenerator<string, Embedding<float>>>(sp =>
        {
            ...
            return new EmbeddingGeneratorBuilder<string, Embedding<float>>(
                ...
                .UseOpenTelemetry(sourceName: WatchtowerTelemetry.ExtensionsAiSourceName)
                .Build(sp);
        });
    ...
    /// </summary>
    public static IServiceCollection AddWatchtowerLlmWithoutPersistence(
        this IServiceCollection services,
        IConfiguration configuration)
    {
        services.AddWatchtowerLlm(configuration);
