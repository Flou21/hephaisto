...
/// <c>HEPHAISTO_MODE=atuo</c>. It MUST constrain to Observe. Treating a typo as silence
...
/// <c>HEPHAISTO_MODE=observe</c> to STOP an agent running in Auto must actually stop it -
...
public static class ModeResolver
{
    ...
    /// integer, so <c>HEPHAISTO_MODE=3</c> would quietly mean Auto. An operator typing a
