...
public enum SignalSource
{
    ...
    /// <summary>
    /// Watchtower's own telemetry alerting on Watchtower. Signals from this source are
...
/// <summary>
/// The closed vocabulary of things Watchtower can do to the cluster. This is deliberately
...
/// ones (<c>watchtower/auto</c>), so "who did this" is answerable uniformly.
/// </summary>
public enum ApprovalSource
{
    ...
    Ui = 0,
    Api = 1,
    /// <summary>Executed by policy under L3 autonomy. ApprovedBy is <c>watchtower/auto</c>.</summary>
    Auto = 2,
