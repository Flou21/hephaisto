...
namespace Watchtower.Core.Classification;
...
/// <c>WatchtowerLlmBudgetExhausted</c>, teaches one copy about it, and the same alert is then
...
public static class AlertClassifier
{
    ...
    /// </summary>
    public const string KindLabel = "watchtower_kind";
