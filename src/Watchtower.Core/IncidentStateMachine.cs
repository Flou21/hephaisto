...
public sealed class IncidentStateMachine(IClock clock)
{
    ...
    /// </summary>
    public const string ModelActor = "watchtower/model";

    public const string VerifierActor = "watchtower/verifier";

    public const string SystemActor = "watchtower/system";

    private static readonly string[] ForbiddenGranters = [ModelActor, "model", "llm", "gemini", "watchtower/llm"];
